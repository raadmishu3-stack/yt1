...
edit_vm_config() {
    ...
    if load_vm_config "$vm_name"; then
        ...
        while true; do
            ...
            echo "  4) :electric_plug:SSH Port"
            echo "  5):desktop:  GUI Mode"
            echo "  6) Port Forwards"
            echo "  7):brain: Memory (RAM)"
            echo "  8):minidisc: CPU Count"
            echo "  9):floppy_disk:Disk Size"
